...
CONTAINS
   ...
   SUBROUTINE sbc_cpl_init( k_ice )     
      ...
      !
      IF( nn_timing.gt.0 .and. nn_timing .le. 2)  CALL timing_start('sbc_cpl_init')
      !
...
! Currently no namelist entry to determine sending of multi-category ice fraction so use the thickness entry for now
      ...
      !
      IF( nn_timing.gt.0 .and. nn_timing .le. 2 )  CALL timing_stop('sbc_cpl_init')
      !
...
!CDIR NOVERRCHK
      ...
      !
      IF( nn_timing.gt.0 .and. nn_timing .le. 2 )  CALL timing_stop('sbc_cpl_rcv')
      !
   ...
   SUBROUTINE sbc_cpl_ice_tau( p_taui, p_tauj )     
      ...
      !!----------------------------------------------------------------------
      !
      IF( nn_timing.gt.0 .and. nn_timing .le. 2 )  CALL timing_start('sbc_cpl_ice_tau')
      !
      ...
      !
      IF( nn_timing.gt.0 .and. nn_timing .le. 2 )  CALL timing_stop('sbc_cpl_ice_tau')
      !
   ...
   SUBROUTINE sbc_cpl_ice_flx( p_frld, palbi, psst, pist )
      ...
      !!----------------------------------------------------------------------
      !
      IF( nn_timing.gt.0 .and. nn_timing .le. 2 )  CALL timing_start('sbc_cpl_ice_flx')
      !
...
!       ( see OASIS3 user guide, 5th edition, p39 )
      ...
      !
      IF( nn_timing.gt.0 .and. nn_timing .le. 2 )  CALL timing_stop('sbc_cpl_ice_flx')
      !
   ...
   SUBROUTINE sbc_cpl_snd( kt )
      ...
      !!----------------------------------------------------------------------
      !
      IF( nn_timing.gt.0 .and. nn_timing .le. 2 )  CALL timing_start('sbc_cpl_snd')
      !
...
! Temporarily Changed for HadGEM3
      ...
      !
      IF( nn_timing.gt.0 .and. nn_timing .le. 2 )  CALL timing_stop('sbc_cpl_snd')
      !
